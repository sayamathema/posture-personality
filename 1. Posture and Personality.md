...
**So if we are to follow the data, most people in our society, the majority of people are outgoing, playful, energetic and comfortable taking risk.**

Upon trying to analyse the relation between the posture and the personality type, we found out the following relationship. 
